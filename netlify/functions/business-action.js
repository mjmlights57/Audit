...
async function deleteOrArchiveCustomer(supabase, id) {
  ...
  const used = await anyReferences(supabase,[
    ['projects','customer_id',id],['invoices','customer_id',id],['payments','customer_id',id],['financial_transactions','customer_id',id],['bank_transactions','customer_id',id],['mileage_trips','customer_id',id]
  ]);
  if (used) {
...
async function deleteOrArchiveProject(supabase, id) {
  ...
  const used = await anyReferences(supabase,[
    ['invoices','project_id',id],['payments','project_id',id],['financial_transactions','project_id',id],['bank_transactions','project_id',id],['time_entries','project_id',id],['worker_payments','project_id',id],['mileage_trips','project_id',id]
  ]);
  if (used) {
...
async function deleteOrDeactivateWorker(supabase, id) {
  ...
  const used = await anyReferences(supabase,[['time_entries','worker_id',id],['worker_payments','worker_id',id],['mileage_trips','worker_id',id],['project_workers','worker_id',id]]);
  if (used) {
