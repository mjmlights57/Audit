...
exports.handler = async (event) => {
  ...
  const text = [
    ...
    'The audit was completed in the EWPros Auditor Wizard. Dropbox upload is not yet enabled.',
  ].join('\n');
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;line-height:1.55;color:#1f2937;max-width:640px;margin:auto">
      ...
      <p style="margin-top:20px"><strong>The audit was completed in the EWPros Auditor Wizard.</strong></p><p style="color:#6b7280">Dropbox upload is not yet enabled.</p>
    </div>`;
