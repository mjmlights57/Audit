...
test('v3.0.3 bank file selection enables import control',()=>{
  ...
  assert.match(js,/button\.disabled=(?:!hasFile|false)/);
  assert.match(js,/(?:Preview statement is optional|validates at click|Choose a statement file, then click Import transactions)/);
});
