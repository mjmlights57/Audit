...
let state={user:null,route:'home',selectedAppointment:null,deferredPrompt:null,appointmentSearch:'',appointmentFilter:'active'};
...
function freshAuditFields(remote,local={}){
  return {...remote,
    ...
    account:local.account||remote.account||'',signatureName:local.signatureName||'',signature:local.signature||'',noEquipment:local.noEquipment||{},
